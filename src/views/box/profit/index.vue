<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['profit:profit:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
    ...
    <el-table v-loading="loading" :data="profitList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="箱子id" align="center" prop="id" />
      <el-table-column label="箱子id" align="center" prop="boxId" />
      <el-table-column label="开箱次数" align="center" prop="openCount" />
      <el-table-column label="期望盈利" align="center" prop="expectProfit" />
      <el-table-column label="实际盈利" align="center" prop="actualProfit" />
      <el-table-column label="超出预期盈利额" align="center" prop="exceedValue" />
      <el-table-column label="箱子中所开的商品总价" align="center" prop="prizeGoodsMoney" />
...
<script>
import { listProfit, getProfit, delProfit, addProfit, updateProfit, exportProfit } from "@/api/box/profit";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除箱子盈利编号为"' + ids + '"的数据项?', "警告", {
